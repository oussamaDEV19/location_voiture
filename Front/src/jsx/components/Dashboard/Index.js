...
const Index = () => {
  ...
  const [nbAvancemens, setNbAvancemens] = useState(0);

  useEffect(() => {
    const fetchResult = async () => {
      const res = await axios.get("http://localhost:8800/api/contrats/result");
      const res1 = await axios.get("http://localhost:8800/api/voitures/result");
      const res2 = await axios.get("http://localhost:8800/api/clients/result");
      const res3 = await axios.get(
        "http://localhost:8800/api/prolongations/result"
      );

      setNbContrats(res.data);
      setNbClients(res1.data);
      setNbVoitures(res2.data);
      setNbAvancemens(res3.data);
    };
    fetchResult();
  }, []);
      ...
      <div className="row">
        <div className="col-xl-3 col-xxl-6 col-lg-6 col-sm-6">
          <div className="card card-bd">
            <div className="bg-info card-border" />
            <div className="card-body">
              <div className="media align-items-center">
                <div className="media-body mr-3">
                  ...
                  <span className="fs-14">Total des Contrats</span>
                </div>
                <svg
                  width="36"
                  height="36"
        ...
        <div className="col-xl-3 col-xxl-6 col-lg-6 col-sm-6">
          <div className="card card-bd">
            <div className="bg-warning card-border" />
            <div className="card-body">
              <div className="media align-items-center">
                <div className="media-body mr-3">
                  <h2 className="num-text text-black font-w700">{nbClients}</h2>
                  <span className="fs-14">Total des Clients</span>
                </div>
                <svg
                  width="36"
                  height="36"
        ...
        <div className="col-xl-3 col-xxl-6 col-lg-6 col-sm-6">
          <div className="card card-bd">
            <div className="bg-primary card-border" />
            <div className="card-body">
              <div className="media align-items-center">
                <div className="media-body mr-3">
                  <h2 className="num-text text-black font-w700">
                  ...
                  <span className="fs-14">Total des Voitures</span>
                </div>
                <svg
            ...
            <div className="card-body">
              <div className="media align-items-center">
                <div className="media-body mr-3">
                  ...
                  <span className="fs-14">Total des Avancements</span>
                </div>
                <svg
                  width="46"
                  height="46"
